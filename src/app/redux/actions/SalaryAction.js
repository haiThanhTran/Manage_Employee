export const GET_SALARY_BY_EMPLOYEE_REQUEST = "GET_SALARY_BY_EMPLOYEE_REQUEST";
export const GET_SALARY_BY_EMPLOYEE_SUCCESS = "GET_SALARY_BY_EMPLOYEE_SUCCESS";
export const GET_SALARY_BY_EMPLOYEE_FAIL = "GET_SALARY_BY_EMPLOYEE_FAIL";
export const GET_SALARY_BY_LEADER_REQUEST = "GET_SALARY_BY_LEADER_REQUEST";
...
export const UPDATE_SALARY_BY_EMPLOYEE_REQUEST =
  "UPDATE_SALARY_BY_EMPLOYEE_REQUEST";
export const UPDATE_SALARY_BY_EMPLOYEE_SUCCESS =
  "UPDATE_SALARY_BY_EMPLOYEE_SUCCESS";
export const UPDATE_SALARY_BY_EMPLOYEE_FAIL = "UPDATE_SALARY_BY_EMPLOYEE_FAIL";
export const DELETE_SALARY_BY_EMPLOYEE_REQUEST =
  "DELETE_SALARY_BY_EMPLOYEE_REQUEST";
export const DELETE_SALARY_BY_EMPLOYEE_SUCCESS =
...
export const getSalaryByEmployee = (id) => {
  return {
    type: GET_SALARY_BY_EMPLOYEE_REQUEST,
    id,
  };
};
export const getSalaryByEmployeeSuccess = (payload) => {
  return {
    type: GET_SALARY_BY_EMPLOYEE_SUCCESS,
    payload,
  };
};
export const getSalaryByEmployeeFail = (payload) => {
  return {
    type: GET_SALARY_BY_EMPLOYEE_FAIL,
    payload,
  };
};
...
export const getSalaryByLeader = () => {
  return {
    type: GET_SALARY_BY_LEADER_REQUEST,
  };
};
export const getSalaryByLeaderSuccess = (payload) => {
  return {
    type: GET_SALARY_BY_LEADER_SUCCESS,
    payload,
  };
};
export const getSalaryByLeaderFail = (payload) => {
  return {
    type: GET_SALARY_BY_LEADER_FAIL,
    payload,
  };
};
