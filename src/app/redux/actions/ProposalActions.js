export const GET_PROPOSAL_BY_EMPLOYEE_REQUEST = "GET_PROPOSAL_BY_EMPLOYEE_REQUEST";
export const GET_PROPOSAL_BY_EMPLOYEE_SUCCESS = "GET_PROPOSAL_BY_EMPLOYEE_SUCCESS";
export const GET_PROPOSAL_BY_EMPLOYEE_FAIL = "GET_PROPOSAL_BY_EMPLOYEE_FAIL";
export const GET_PROPOSAL_BY_LEADER_REQUEST = "GET_PROPOSAL_BY_LEADER_REQUEST";
export const GET_PROPOSAL_BY_LEADER_SUCCESS = "GET_PROPOSAL_BY_LEADER_SUCCESS";
export const GET_PROPOSAL_BY_LEADER_FAIL = "GET_PROPOSAL_BY_LEADER_FAIL";
...
export const getProposalByEmployee = (id) => {
  return {
    type: GET_PROPOSAL_BY_EMPLOYEE_REQUEST,
    id,
  };
};
export const getProposalByEmployeeSuccess = (payload) => {
  return {
    type: GET_PROPOSAL_BY_EMPLOYEE_SUCCESS,
    payload,
  };
};
export const getProposalByEmployeeFail = (payload) => {
  return {
    type: GET_PROPOSAL_BY_EMPLOYEE_FAIL,
    payload,
  };
};

export const getproposalByLeader = () => {
  return {
    type: GET_PROPOSAL_BY_LEADER_REQUEST,
  };
};
export const getproposalByLeaderSuccess = (payload) => {
  return {
    type: GET_PROPOSAL_BY_LEADER_SUCCESS,
    payload,
  };
};
export const getproposalByLeaderFail = (payload) => {
  return {
    type: GET_PROPOSAL_BY_LEADER_FAIL,
    payload,
  };
};
